...
describe('ThemeComponent', () => {
  ...
  it('should be able to check default text and video slider settings', async () => {
    ...
    const textSizeSlider: MatSliderHarness = await loader.getHarness(
    ...
    expect(await textSizeSlider.getValue()).toBe(Number(textSizeSetting));
  });
  ...
  it('should be able to update video size slider setting', async () => {
    ...
    const videoSizeSetting: number = Number(
      themeService.getSetting('videoSize')
    );
